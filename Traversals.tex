...
My gateway drug to category theory was the Haskell lens library. What first peaked my attention was the van Laarhoven representation, which used functions that are functor-polymorphic. The following function type:
\begin{haskell}
type Lens s t a b = 
